...
ALTER TABLE post ADD COLUMN vote_num INT DEFAULT 0;


ALTER TABLE post ADD INDEX idx_community_status_id (community_id, status, id);
ALTER TABLE post ADD INDEX idx_status_id (status, id);
